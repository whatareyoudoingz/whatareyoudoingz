...
<table>
  ...
  <tr>
    ...
    <tr>
    <td>`2022.03 ~ 2022.06` <br>
        <br> `2022.06 ~ 2022.08` <br>
        <br> `2022.07 ~ 2022.09` <br>
        <br> `2022.09 ~ 2023.02` <br>
        <br> `2022.10 ~ 2022.10` <br>
        <br> `2022.11 ~ 2023.05` <br>
        <br> `2022.12 ~ 2023.06` <br>
        <br> `2023.02 ~ 2023.02` <br>
        <br> `2023.02 ~ 2023.10` <br>
        <br> `2023.03 ~ 2023.06` <br>
        <br> `2023.06 ~ 2023.08` <br>
        <br> `2023.11 ~ 2023.12` <br>
        <br> `2024.01 ~ 2024.02` <br>
    </td>
    <td>K-water 대국민 물 빅데이터 공모전 참가 <br>
        <br> 수원대학교 & 데이콘 Data Science 실무 역량 강화 교육 참가 <br>
        <br> KISTI 연구데이터 분석활용 경진대회 참가 <br>
        <br> 수원대학교 DSML AL/SW Developers 1기 수료 <br>
        <br> 데이콘 자율주행 센서의 안테나 성능 예측 AI 경진대회 참가 <br>
        <br> **BDA** 5기 데이터 분석 기초반 수료 <br>
        <br> 멀티캠퍼스 KDT 2기 풀스택 개발자 취업캠프(PYTHON) 수료 <br>
        <br> 프로메데우스 스타트업 해커톤 수료 <br>
        <br> **수원대학교** 학부연구생 참여 <br>
        <br> ETRI 제2회 휴먼이해 인공지능 논문 경진대회 참가 <br>
        <br> **데이터 청년 캠퍼스** 을지대학교 과정 참가 <br>
        <br> **케어크루즈** 인턴 <br>
        <br> **한국전자통신연구원** 연구연수생 <br>
  </tr>
    <tr>
    <td>내용</td>
    <td>내용</td>    
